...
@section('content')
  <main class="container my-4 d-flex flex-column">
    <header class="my-3 hstack gap-2">
      ...
      <h3 class="fw-bold m-0">Detail Transaksi</h3>
    </header>
      ...
      <div class="col">
        <div class="card bg-primary-light h-100 border-0">
          <div class="card-body">
            ...
            <p class="fs-5">{{ $transaksi->status }}</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="col">
        <div class="card border-0 shadow">
          <div class="card-header border-0 bg-transparent">
            <p class="fs-4 card-title fw-bold mb-0">Detail Pesanan</p>
          </div>
          <div class="card-body">
            <div class="row row-cols-2 gy-2">
              ...
              <div class="col">{{ $transaksi->status }}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card border-0 shadow">
          ...
          <div class="card-body">
            ...
            <div class="row row-cols-2 mt-3 gy-2">
              ...
              <div class="col">{{ $reseller->alamat }}</div>
            </div>
          </div>
        </div>
      </div>
